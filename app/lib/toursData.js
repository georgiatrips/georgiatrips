...
export const DESTINATIONS = [
  { value: "all", label: "ყველა მიმართულება" },
  { value: "batumi", label: "ბათუმი / აჭარა" },
  { value: "kazbegi", label: "ყაზბეგი / სტეფანწმინდა" },
  { value: "tbilisi", label: "თბილისი / მცხეთა" },
  { value: "kakheti", label: "კახეთი" },
  { value: "svaneti", label: "სვანეთი / მესტია" },
...
export const ALL_TOURS_SCHEDULE = [
  ...
  },
  {
    ...
    priceNote: "ფასდაკლება ბავშვებისთვის",
    locationShort: "ბათუმიდან, ჩაქვიდან, ქობულეთიდან. ბანაობა თე���������ლ წყაროებში",
...
export function getTourDetails(tour) {
  const detailsMap = {
    "promethe-martvili": {
      ...
      reviews: [
        { name: "გიორგი მ.", date: "2026 წლის ივლისი", rating: 5, comment: "საოცარი ტური იყო! გიდი ძალიან ყურადღებ���ანი, მარტვილის კანიონი და პრომეთეს მღვიმე უბრალოდ ჯადოსნურია." },
